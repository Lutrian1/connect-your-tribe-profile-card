...
personResponseJSON.data.custom = JSON.parse(personResponseJSON.data.custom) // custom field renderen als jason dus zodra ik in mijn html dit doorgeef rendered hij de json 
...
app.get('/', async function (request, response) {
   ...
   response.render('index.liquid', {person: personResponseJSON.data}) // geeft mee dat hij aan de liquid de personData moet geven
})
...
app.get('/oefenen', async function (request, response) {
  ...
  response.render('oefenen.liquid', {person: personResponseJSON.data}) // geeft mee dat hij aan de liquid de personData moet geven
})
